    ...
    var methods = {
        init : function(options) {
            this.each(function() {
                ...
                var $scrollObj = $(this).scrollTop(0).scrollLeft(0).css({
                    'overflow': 'hidden'
                }).data({
                ...
                if (isTouch) {
                    ...
                    .mouseup(function() {
                        ...
                        $verticalBar.stop(true, true).animate({
                            'top': newTopPos / verticalScrollMultiplier
                        }, settings['animation-time']);
                        $horizontalBar.stop(true, true).animate({
                            'left': newLeftPos / horizontalScrollMultiplier
                        }, settings['animation-time']);
                        if (settings['hide-bars']) {
                ...
                function handleSizeChanges() {
                    ...
                    if (($scrollContent.height() != scrollContentHeight) || ($scrollContent.width() != scrollContentWidth) || ($scrollObj.width() != scrollHolderWidth) || ($scrollObj.height() != scrollHolderHeight)) {
                        ...
                        $scrollContent.stop(true, false).animate( {
                            ...
                            duration: settings['animation-time'] / 2, 
                            queue: true
                        });
                ...
                function handleMouseWheel(event) {
                    ...
                    $verticalBar.stop(true, false).animate({
                        'top': newContentTop / verticalScrollMultiplier
                    }, {
                        duration: settings['animation-time'], 
                        queue: true, 
                        easing: settings['easing']
