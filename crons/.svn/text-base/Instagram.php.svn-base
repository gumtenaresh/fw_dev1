...
class Instagram {
    ...
    public function getAccessToken() {
        if (isset($_SESSION['InstagramAccessToken'])) {
            error_log("this is instagram.php main getaccesstoken if part" . $_SESSION['InstagramAccessToken']);
            return $this->_accessToken = $_SESSION['InstagramAccessToken'];
        } else {
            error_log("this is instagram.php main getaccesstoken else part" . $_SESSION['InstagramAccessToken']);
    ...
    public function getUserRecent($id, $maxId = '', $minId = '', $maxTimestamp = '', $minTimestamp = '') {
        ...
        //echo'<pre>';print_r($endpointUrl);exit;
        $this->_initHttpClient($endpointUrl);
        return $this->_getHttpClientResponse();
    }
